			...
			<div class="col-xs-8 col-sm-8 col-md-9 col-lg-8 main">
				...
				<div role="tabpanel">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" class="h3 ${param.action=='all'? 'active' :''}"><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">廣告清單</a></li>
						<li role="presentation" class="h3 ${param.action=='add'? 'active' :''}"><a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">新增廣告</a></li>
						<li role="presentation" class="h3 ${param.action=='update'? 'active' :''}"><a href="#tab3" aria-controls="tab3" role="tab" data-toggle="tab">修改廣告</a></li>
					...
					<div class="tab-content">
						...
						<div role="tabpanel" class="tab-pane ${param.action=='all'? 'active' :''}" id="tab1">
							<jsp:include page="listAllCm.jsp"/>
						</div>
						<div role="tabpanel" class="tab-pane ${param.action=='add'? 'active' :''}" id="tab2">
							<jsp:include page="addCm.jsp"></jsp:include>
						</div>
						<div role="tabpanel" class="tab-pane ${param.action=='update'? 'active' :''}" id="tab3">
							<%
							if (request.getAttribute("cmVO") != null) {
						%>
								<jsp:include page="update_cm_input.jsp" />
						<%
						}else{
						%>
						<div class="h2">
