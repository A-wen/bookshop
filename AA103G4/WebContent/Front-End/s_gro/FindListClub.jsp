...
<section id="body-section">
        <div id="main" class="body-height-min" style="margin-bottom:80px">
            <div class="container">                          
	           	<div id="contentsList">
	                <c:forEach var="s_gro_infoVO" items="${find_club}">
	                    <div class="contents-d contents-m contents">
	                        <div class="contents-child">
                                ...
                                <span>                               	
									...
									<BUTTON type=submit class="btn btn-success">我要加入</BUTTON>  
									<input type="hidden" name="mem_no" size="45"  value="${idd}" />
									<input type="hidden" name="s_gro_no" size="45"  value="${s_gro_infoVO.s_gro_no}" />
									<input type="hidden" name="s_gro_sta" size="45"  value="${s_gro_infoVO.s_gro_sta}" />
				<%-- 					<input type="hidden" name="requestURL" value="<%=request.getServletPath()%>"> --%>
