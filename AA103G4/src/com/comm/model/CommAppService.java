...
public class CommAppService {
	private CommAppDAO_interface dao;

	public CommAppService() {
		dao = new CommAppDAO();
	}
	...
	/** 查詢某本書的評論 **/
	public Map<String, CommVO> getCommByBook(Integer book_no) {
	...
	public CommVO addBookComment(Integer book_no, Integer mem_no, String comm_desc, 
			 Integer comm_level){  //Date comm_date,
		CommVO commVO = new CommVO();
		commVO.setBook_no(book_no);
		commVO.setMem_no(mem_no);
		commVO.setComm_desc(comm_desc);
